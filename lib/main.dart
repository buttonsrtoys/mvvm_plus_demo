...
class CounterPage extends View<CounterPageViewModel> {
  CounterPage({super.key})
      : super(
            builder: () => CounterPageViewModel(), location: Location.registry);
        ...
        body: Center(
            child: Row(
              ...
              Text(viewModel.letterCount.value,
                  style: TextStyle(
                    fontSize: 64,
                    color: listenTo<ColorService>(context: context).color.value,
                  )),
...
class CounterPageViewModel extends ViewModel {
  ...
  void incrementLetter() => letterCount.value = letterCount.value == 'z'
      ? 'a'
...
class IncrementButtonViewModel extends ViewModel {
  ...
  void incrementCounter() {
    isNumber.value
        ...
        : get<CounterPageViewModel>().incrementLetter();
